...
steps:
  ...
  permanent-atrial-fibrillation---primary:
    run: permanent-atrial-fibrillation---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  atrial-fibrillation-flutter---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: permanent-atrial-fibrillation---primary/output
  ...
  atrial-fibrillation-specified---primary:
    run: atrial-fibrillation-specified---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: atrial-fibrillation-specified---primary/output
class: Workflow
inputs:
  potentialCases:
    id: potentialCases
